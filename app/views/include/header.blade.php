                ...
                <div class="header-login-form span5">
                    ...
                    <div class="guest-options clear-both">
                        @if(Auth::check())
                            ...
                            @endif
                        @else
                            <a href="{{URL::to('/olvido')}}">{{Lang::get('content.forgot_password')}}</a> &nbsp;  |  &nbsp; <a class="manito" nohref onclick="Mercatino.registerForm.show();"><b>{{Lang::get('content.register_signup')}}</b></a>
                        @endif
                    </div>
                </div>
            </div>
