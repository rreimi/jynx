Hola {{ $userName }},<br/>
<br/>
¡Bienvenido a Tu.Mercato.com!<br/>
<br/>
Hemos confirmado que su perfil de anunciante {{ $sellerName }}, registrado con el RIF/Cédula
número {{ $letterRifCi }}-{{ $rifCi }}, es socia de la Cámara de Comercio Venezolana-Italiana, por lo que su solicitud fue
aprobada.<br/>
<br/>
