...
return array(
	...
	*/
    ...
    "register_dialog_continue" => "Sí quiero publicar",
    ...
    "content.register_dialog_header" => "¿Quieres optar a ser anunciante?",
    "content.register_dialog_description" => "Si eres un asociado a la Cámara de Comercio Venezolano-Italiana (CAVENIT), se te harán una serie de preguntas para optar a publicar productos y/o servicios. De lo contrario, puedes saltarte este paso para navegar por Mercatino.",
