...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publishers` (
  ...
  `deleted_at` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_publishers_users_idx` (`user_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publications_images` (
  ...
  `updated_at` DATETIME NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_publications_images_publications_idx` (`publication_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`advertisings` (
  ...
  `deleted_at` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_advertisings_categories_idx` (`category_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`contacts` (
  ...
  `deleted_at` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_contacts_publishers_idx` (`publisher_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publications_categories` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_publication_categories_publications_idx` (`publication_id` ASC) ,
  INDEX `fk_publication_categories_categories_idx` (`category_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publications_reports` (
  ...
  `deleted_at` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_publication_reports_publications_idx` (`publication_id` ASC) ,
  INDEX `fk_publication_reports_users_idx` (`user_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publications_ratings` (
  ...
  INDEX `fk_publication_raitings_publications_idx` (`publication_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publishers_categories` (
  ...
  `category_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_publishers_categories_publishers_idx` (`publisher_id` ASC) ,
  INDEX `fk_publishers_categories_categories_idx` (`category_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publishers_reports` (
  ...
  `updated_at` DATETIME NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_publishers_reports_user_idx` (`user_id` ASC) ,
  INDEX `fk_publishers_reports_publishers_idx` (`publisher_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `mercatino`.`publications_visits` (
  ...
  `publication_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_publications_visits_publications_idx` (`publication_id` ASC) ,
