ALTER TABLE  `publishers` ADD  `country_id` INT NOT NULL AFTER  `status_publisher`;
ALTER TABLE  `jobs` ADD  `country_id` INT NOT NULL AFTER  `company_name` ;
ALTER TABLE  `states` ADD  `country_id` INT NOT NULL ;
...
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Catamarca');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Córdoba');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Corrientes');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Chaco');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Chubut');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Entre Ríos');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Formosa');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Jujuy');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'La Pampa');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'La Rioja');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Mendoza');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Misiones');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Neuquén');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Río Negro');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Salta');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'San Juan');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'San Luis');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Santa Cruz');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Santa Fe');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Santiago del Estero');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Tierra del Fuego, Antártida e Islas del Atlántico Sur');
INSERT INTO states (code, country_id, name) VALUES ('AR-', 12, 'Tucumán');

-- ECUADOR ESTADOS --
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Azuay');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Bolivar');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Cañar');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Carchi');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Chimborazo');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Cotopaxi');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'El Oro');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Esmeralda');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Galápagos');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Guayas');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Imbabura');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Loja');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Los Rios');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Manabí');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Morona Santiago');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Napo');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Orellana');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Pastaza');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Pichincha');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Santa Elena');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Santo Domingo de los Tsáchilas');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Sucumbíos');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Tungurahua');
INSERT INTO states (code, country_id, name) VALUES ('EC-', 62, 'Zamora Chinchipe');